...
```{r colours, fig.height=5, echo = FALSE, echo=FALSE, include = FALSE}
dslabs::gapminder %>%
  ...
  scale_color_manual(values = c("red",
                                ...
                                "darkgoldenrod4",
                                "steelblue4")) + #BREAK
  scale_color_brewer(type = 'qual') + #BREAK
  scale_color_brewer(type = 'div') + #BREAK
  scale_color_viridis_d(option = 'magma') + #BREAK
  scale_color_paletteer_d(palette = 'MapPalettes::irish_flag') #BREAK

```

---

`r chunk_reveal("colours", break_type = 'user')`
...
`r chunk_reveal("histogram-colours")`
...
```{r facet_example1, eval = FALSE, echo = T, message=F, warning=F}
sex <- c("Female", "Male")
names(sex) <- c("F", "M")
...
```{r facet_example1-out, ref.label="facet_example1", echo=FALSE, out.width = "75%", out.height="40%"}
```

---

```{r facet_example2, eval = F, message = F, warning = F, echo = T}
movielens %>%      ### movielens dataset from dslabs
  ...
  theme(text = element_text(size = 14),
        ...
        strip.text = element_text(family = "Ink Free", 
                                  face = "bold", 
                                  size = 14, 
                                  colour = "firebrick4"),
        axis.title.x = element_blank())
...
```{r facet_example2-out, ref.label="facet_example2", echo=FALSE, out.width = "75%", out.height="40%"}
```
...
```{r facet_example3, eval = F, message = F, echo = T, warning = F}
...
```{r facet_example3-out, ref.label="facet_example3", echo=FALSE, out.width = "75%", out.height="40%"}
```
